...
# Try to import GPU metering if available
try:
...
API_KEYS_ENV = os.environ.get("ADMIN_API_KEYS", "test-key")
API_KEYS = set(API_KEYS_ENV.split(",") if API_KEYS_ENV else ["test-key"])
